...
Test project that is based on [Matteo Manferdini](https://github.com/matteom) tutorial [Launches](https://github.com/matteom/Launches) on advanced use of the Codable protocol.

I thoroughly disassembled each line of the sample project and rewrote, partially made it my own way.

Many thanks to Matteo for a well-written article 👍

  <p float="right">
  <img src="SpaceX/Assets.xcassets/demo-1.imageset/demo-1.png" width="32%"/>
  <img src="SpaceX/Assets.xcassets/demo-2.imageset/demo-2.png" width="32%"/>
  </p>
